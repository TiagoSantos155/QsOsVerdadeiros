...
public class CoordinatorLoginController implements Main.StageAwareController {
    ...
    public void validarCredenciais() {
        ...
        if (utilizador != null && utilizador.getSenha().equals(password)) {
            loadScene("/org/example/testejavafxmaven/coordinator_panel.fxml", "Painel do Utilizador");
        } else {
