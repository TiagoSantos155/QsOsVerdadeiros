...
public class EpocaDAO {
    public void salvar(String tipo, String inicio, String fim, int semestreId) {
        String sql = """
            INSERT INTO epocas (tipo, inicio, fim, semestre_id)
            VALUES (?, ?, ?, ?)
        """;
    ...
    public String listarEpocas(int semestreId) {
        StringBuilder sb = new StringBuilder();
        String sql = "SELECT * FROM epocas WHERE semestre_id = ?";
